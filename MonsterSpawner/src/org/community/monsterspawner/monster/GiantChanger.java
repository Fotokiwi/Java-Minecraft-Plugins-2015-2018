...
public class GiantChanger {

	@SuppressWarnings("unused")
	private MonsterSpawner plugin;


	public GiantChanger(MonsterSpawner plugin) {
		this.plugin = plugin;
	}

	private static final UUID movementSpeedUID = UUID.fromString("206a89dc-ae78-4c4d-b42c-3b31db3f5a7c");
	private static final UUID maxHealthUID = UUID.fromString("206ab5d23c-aD78-41cd-b42c-3b31c33f5a7c");
	...
	private static final UUID attackDamageUID = UUID.fromString("206a8666-a175-4c4d-b42c-3b31db3f5a7c");

	public void changeGiant(Giant giant, Spawner spawner){
		...
		try {
			...
			if(!spawner.getPotion().equalsIgnoreCase("none")){
				giant.addPotionEffect(new PotionEffect(PotionEffectType.getByName(spawner.getPotion()), 8640000, 1));
			}
			...
			e.printStackTrace();
			Bukkit.broadcastMessage("Fehler im Change Giant");
		}
	}
}